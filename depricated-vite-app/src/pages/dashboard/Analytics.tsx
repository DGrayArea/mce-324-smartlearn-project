...
import { BarChart3, TrendingUp, Users, BookOpen, Award, Calendar, Download, Eye, Filter } from 'lucide-react';
...
const Analytics = () => {
  ...
  const getEngagementBadge = (engagement: string) => {
    ...
    return <Badge variant={variants[engagement as keyof typeof variants]}>{engagement}</Badge>;
  };
  ...
  const filteredStudents = studentAnalytics.filter(student => {
    ...
    const matchesEngagement = selectedEngagement === 'all' || student.engagement === selectedEngagement;
                ...
                <CardContent className="p-6">
                  <div className="flex items-start justify-between mb-4">
                    <div>
                      ...
                      <p className="text-muted-foreground">ID: {student.studentId} • Course: {student.course}</p>
                    </div>
                    <div className="flex items-center space-x-2">
                      {getEngagementBadge(student.engagement)}
                      <Badge variant="outline">{student.averageGrade.toFixed(1)}%</Badge>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
                    ...
                    <div>
                      ...
                      <div className="flex items-center space-x-2">
                        <Progress value={(student.assignmentsCompleted / student.totalAssignments) * 100} className="flex-1" />
                        <span className="text-sm font-medium">{student.assignmentsCompleted}/{student.totalAssignments}</span>
                      </div>
                    </div>
                    <div>
                ...
                <CardContent>
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="text-2xl font-bold">{course.engagementScore}%</div>
                      <Progress value={course.engagementScore} className="h-2" />
                    </div>
                    <div className="space-y-2">
                      <p className="text-sm text-muted-foreground">Activities This Week</p>
                      <div className="text-2xl font-bold">{course.activitiesThisWeek}</div>
                    </div>
                  </div>
                </CardContent>
              </Card>
            ...
            <CardContent>
              <div className="h-96 flex items-center justify-center text-muted-foreground">
                <div className="text-center">
                  ...
                  <p>Performance charts and trends visualization would be displayed here</p>
