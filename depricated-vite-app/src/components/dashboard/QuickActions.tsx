  ...
  const renderStudentActions = () => (
    <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3">
      ...
      <Button 
        variant="outline" 
        className="h-auto p-3 sm:p-4 flex flex-col items-center space-y-2 hover:shadow-medium transition-shadow"
        onClick={() => handleAction("Submit Assignment", "/dashboard/assignments")}
      >
        <FileText className="h-5 w-5 sm:h-6 sm:w-6 text-warning" />
        <span className="text-xs font-medium text-center">Submit Assignment</span>
      </Button>
      <Button 
        variant="outline" 
        className="h-auto p-3 sm:p-4 flex flex-col items-center space-y-2 hover:shadow-medium transition-shadow"
      ...
      <Button 
        variant="outline" 
        className="h-auto p-3 sm:p-4 flex flex-col items-center space-y-2 hover:shadow-medium transition-shadow"
        onClick={() => handleAction("Download Notes", "/dashboard/content-library")}
      >
  ...
  const renderLecturerActions = () => (
    <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3">
      <Button 
        variant="outline" 
        className="h-auto p-3 sm:p-4 flex flex-col items-center space-y-2 hover:shadow-medium transition-shadow"
        onClick={() => handleAction("Upload Content", "/dashboard/content-library")}
      >
      ...
      >
        ...
        <span className="text-xs font-medium text-center">Schedule Meeting</span>
      </Button>
      <Button 
        variant="outline" 
        className="h-auto p-3 sm:p-4 flex flex-col items-center space-y-2 hover:shadow-medium transition-shadow"
      ...
      <Button 
        variant="outline" 
        className="h-auto p-3 sm:p-4 flex flex-col items-center space-y-2 hover:shadow-medium transition-shadow"
        onClick={() => handleAction("Create Assignment", "/dashboard/assignments")}
      >
        <FileText className="h-5 w-5 sm:h-6 sm:w-6 text-destructive" />
        <span className="text-xs font-medium text-center">Create Assignment</span>
      </Button>
      <Button 
        variant="outline" 
        className="h-auto p-3 sm:p-4 flex flex-col items-center space-y-2 hover:shadow-medium transition-shadow"
      ...
      >
        <MessageSquare className="h-5 w-5 sm:h-6 sm:w-6 text-primary" />
        <span className="text-xs font-medium text-center">Answer Questions</span>
      </Button>
      <Button 
        variant="outline" 
        className="h-auto p-3 sm:p-4 flex flex-col items-center space-y-2 hover:shadow-medium transition-shadow"
      ...
      >
        <Award className="h-5 w-5 sm:h-6 sm:w-6 text-success" />
        <span className="text-xs font-medium text-center">Issue Certificates</span>
      </Button>
    </div>
  );
  ...
  const renderAdminActions = () => (
    <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3">
      <Button 
        variant="outline" 
        className="h-auto p-3 sm:p-4 flex flex-col items-center space-y-2 hover:shadow-medium transition-shadow"
        onClick={() => handleAction("Manage Users", "/dashboard/user-management")}
      >
      ...
      >
        <BookOpen className="h-5 w-5 sm:h-6 sm:w-6 text-secondary" />
        <span className="text-xs font-medium text-center">Course Management</span>
      </Button>
      <Button 
        variant="outline" 
        className="h-auto p-3 sm:p-4 flex flex-col items-center space-y-2 hover:shadow-medium transition-shadow"
        onClick={() => handleAction("System Analytics", "/dashboard/system-analytics")}
      >
        <TrendingUp className="h-5 w-5 sm:h-6 sm:w-6 text-accent" />
        <span className="text-xs font-medium text-center">System Analytics</span>
      </Button>
      <Button 
        variant="outline" 
        className="h-auto p-3 sm:p-4 flex flex-col items-center space-y-2 hover:shadow-medium transition-shadow"
        onClick={() => handleAction("Approve Results", "/dashboard/result-approval")}
      >
      ...
      >
        ...
        <span className="text-xs font-medium text-center">Generate Reports</span>
      </Button>
      <Button 
        variant="outline" 
        className="h-auto p-3 sm:p-4 flex flex-col items-center space-y-2 hover:shadow-medium transition-shadow"
      ...
      >
        <Users className="h-5 w-5 sm:h-6 sm:w-6 text-secondary" />
        <span className="text-xs font-medium text-center">Monitor Activity</span>
      </Button>
      <Button 
        variant="outline" 
        className="h-auto p-3 sm:p-4 flex flex-col items-center space-y-2 hover:shadow-medium transition-shadow"
