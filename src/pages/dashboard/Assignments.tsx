...
import { FileText, Calendar, Clock, Download, Upload, Plus } from 'lucide-react';
      ...
      <div className="flex justify-between items-center">
        <div>
          <h2 className="text-3xl font-bold tracking-tight">
            {user?.role === 'lecturer' ? 'Course Assignments' : 'My Assignments'}
          </h2>
            ...
            <CardHeader className="border-b p-4">
              <div className="flex justify-between items-start">
                ...
                <div className="text-right text-xs text-muted-foreground">
                  {assignment.grade !== undefined ? `${assignment.grade}/${assignment.maxGrade}` : `Max: ${assignment.maxGrade}`}
                </div>
              </div>
              ...
              {assignment.grade !== undefined && (
                <div className="space-y-1">
                  <div className="flex justify-between text-xs">
                    <span>Grade</span>
                    <span>{assignment.grade}/{assignment.maxGrade} ({Math.round((assignment.grade/assignment.maxGrade)*100)}%)</span>
                  </div>
