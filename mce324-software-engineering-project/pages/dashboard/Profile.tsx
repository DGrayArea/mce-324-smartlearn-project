  ...
  const getProfileData = () => {
    switch(user?.role) {
      case 'student':
        return {
          achievements: [
            ...
            { title: 'Programming Champion', description: 'Hackathon Winner', icon: GraduationCap },
            { title: 'Perfect Attendance', description: '2 Semesters', icon: Calendar }
          ],
          stats: [
      ...
      case 'lecturer':
        return {
          achievements: [
            { title: 'Excellence in Teaching', description: '2023 Award', icon: Award },
            { title: 'Research Publication', description: '15 Papers', icon: BookOpen },
            { title: 'Student Favorite', description: '4.9/5 Rating', icon: GraduationCap }
          ],
          stats: [
      ...
      case 'admin':
        return {
          achievements: [
            { title: 'System Excellence', description: '99.9% Uptime', icon: Award },
            { title: 'Process Improvement', description: '30% Efficiency Gain', icon: Briefcase },
            { title: 'Leadership Award', description: 'Staff Recognition', icon: GraduationCap }
          ],
          stats: [
